...
def go_dependencies():
    ...
    go_repository(
        name = "io_periph_x_conn_v3",
        importpath = "periph.io/x/conn/v3",
    ...
    go_repository(
        name = "io_periph_x_host_v3",
        importpath = "periph.io/x/host/v3",
        sum = "h1:g4g5xE1XZtDiGl1UAJaUur1aT7uNiFLMkyMEiZ7IHII=",
        version = "v3.8.5",
    )
    go_repository(
